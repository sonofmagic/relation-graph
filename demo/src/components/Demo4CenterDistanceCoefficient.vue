<template>
  <div>
    ...
    >
      <div style="width: 700px">
        <div style="padding-bottom: 10px; color: #333333">
          图谱默认会根据当前可见范围自动调整各个层级之间的距离，<b>图谱会尽量让图谱显得舒展且不超出可见范围</b>。再次基础上你可以选择让距离更大一些或更小一些。
        </div>
        <span class="c-label">层级距离系数:</span>
        <el-slider
          v-model="distanceCoefficient"
          :max="3"
          :min="0.2"
          :step="0.1"
    ...
    <el-button type="success" class="c-show-code-button">
      <el-link
        href="https://github.com/seeksdream/relation-graph/blob/master/doc/demo/Demo4CenterDistanceCoefficient.vue"
        target="_blank"
        style="color: #ffffff"
        >查看代码
      </el-link>
...
export default {
  ...
  methods: {
    ...
    onChangeOption() {
      ...
      this.graphOptions.layouts[0].distance_coefficient =
