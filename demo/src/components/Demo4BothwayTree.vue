  ...
  <div>
    ...
    >
      <el-button type="success" class="c-show-code-button"
        ><el-link
          href="https://github.com/seeksdream/relation-graph/blob/master/doc/demo/Demo4BothwayTree.vue"
          target="_blank"
          style="color: #ffffff"
          >查看代码</el-link
        ></el-button
    ...
    showSeeksGraph(query) {
      var __graph_json_data = {
        ...
        links: [
          ...
          { from: 'R-d', to: 'a', isReverse: true },
          { from: 'R-d-1', to: 'R-d', isReverse: true },
          { from: 'R-d-2', to: 'R-d', isReverse: true },
          { from: 'R-d-3', to: 'R-d', isReverse: true },
