<template>
  <div>
    ...
    <el-button type="success" class="c-show-code-button">
      <el-link
        href="https://github.com/seeksdream/relation-graph/blob/master/doc/demo/Demo4ExpandGradually.vue"
        target="_blank"
        style="color: #ffffff"
        >查看代码
      </el-link>
    ...
    setGraphData() {
      ...
      this.$refs.seeksRelationGraph.setJsonData(
        ...
        (seeksRGGraph) => {
          ...
          var level_1_nodes = seeksRGGraph.getNodeById(__graph_json_data.rootId)
            .lot.childs
